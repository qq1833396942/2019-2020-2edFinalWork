...
public:
    ...
    void setupUi(QDialog *GLctrl)
    {
        ...
        label_2->setGeometry(QRect(480, 90, 71, 21));
        ...
        label_3->setGeometry(QRect(480, 60, 61, 21));
        ...
        label_4->setGeometry(QRect(480, 120, 61, 21));
        label_4->setFont(font);
        password = new QLineEdit(GLctrl);
        password->setObjectName(QString::fromUtf8("password"));
        password->setGeometry(QRect(560, 120, 113, 20));
        widget = new QWidget(GLctrl);
        widget->setObjectName(QString::fromUtf8("widget"));
        widget->setGeometry(QRect(490, 160, 158, 25));
        ...
        widget1 = new QWidget(GLctrl);
        widget1->setObjectName(QString::fromUtf8("widget1"));
        widget1->setGeometry(QRect(490, 190, 158, 25));
        horizontalLayout = new QHBoxLayout(widget1);
        horizontalLayout->setObjectName(QString::fromUtf8("horizontalLayout"));
        horizontalLayout->setContentsMargins(0, 0, 0, 0);
        change = new QPushButton(widget1);
