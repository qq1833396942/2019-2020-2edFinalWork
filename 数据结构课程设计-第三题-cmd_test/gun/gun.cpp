...
bool chooseFunc()
{
    while (true) {
        ...
        cout << "1.获取各省会/直辖市/特区到武汉中转次数" << endl;
        cout << "2.获取指定起点到终点的所有路径" << endl;
        cout << "3.获取单源最短路径 (Dijkstra)" << endl;
        cout << "4.获取绕开指定地点的单源最短路径 (Dijkstra)" << endl;
        cout << "5.获取单源最短路径 (Floyd)" << endl;
        cout << "6.获取多源最短路径" << endl;
        cout << "7.退出程序" << endl;
        cout << "---------------------" << endl;
        ...
        case 4: dijkstra(true); break;
        case 5: floyd_single(30); break;
        case 6: floyd_all(30); break;
        case 7: cout << "退出程序"; return 0;
        default: cout << "指令无效，请重新输入" << endl;
        }
        cout << endl << "信息将会显示7s" << endl;
        Sleep(7000);
        system("cls");
    }
    _getch();
